...
<body class="flex-1 overflow-x-hidden">
        ...
        if ($_SESSION['type'] == 1): // Admin ?>
            <header class="bg-indigo-800 text-white">
                <nav class="flex justify-center">
                    <ul class="container flex justify-between items-center max-w-6xl">
                        <li class="text-2xl font-bold"><a href="/">Diamond Air Academy</a></li>
                        <div class="flex items-center space-x-6">
                            ...
                            <li><a href="/admin/qr" class="hover:text-indigo-200"><i class='bx bx-qr'></i></a></li>
                            <li>
                ...
                <nav class="flex justify-center">
                    <ul class="container flex justify-between items-center max-w-6xl">
                        ...
                        <div class="flex items-center space-x-6">
                            ...
                            <li><a href="/encuestas" class="hover:text-purple-200"><i class='bx bxs-book'></i> Encuestas</a></li>
    ...
    <?php else: // No autenticado ?>
        <header class="bg-pink-600 text-white">
            <nav class="flex justify-center">
                <ul class="flex justify-between items-center container max-w-6xl">
                    <li class="text-2xl font-bold"><a href="/">Diamond Air Academy</a></li>
                    <div class="flex space-x-6">
                        <li><a href="/" class="hover:text-pink-200">Inicio</a></li>
                        <li><a href="/eventos" class="hover:text-pink-200">Cursos</a></li>
    ...
    <div class="w-full h-full">
        <main class="container mx-auto max-w-6xl py-8">
            <?php echo $contenido; ?>
        </main>
    </div>
